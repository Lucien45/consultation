...
import controller.BASCULE_Attente;
...
public class PanelAttente extends JPanel {
	...
	public PanelAttente() {
		...
		btnFiltrer.setIcon(new ImageIcon(PanelAttente.class.getResource("/Icon/filter_24px.png")));
		filtrageDeux();
		...
		panelAdd.setPreferredSize(new Dimension(140, 10));
		...
		btnAdd = new JButton("Basculassions");
		btnAdd.setIcon(new ImageIcon(PanelAttente.class.getResource("/Icon/tilt_24px.png")));
...
//				JOptionPane.showMessageDialog(null,"actulisé!",null,JOptionPane.INFORMATION_MESSAGE);
		...
		lblRefresh.setIcon(new ImageIcon(PanelAttente.class.getResource("/Icon/refresh_30px.png")));
		...
		btnPrev.setBounds(102, 11, 73, 29);
		panel_Pagination.add(btnPrev);
		
		comboChec = new JComboBox();
		comboChec.setBounds(185, 12, 43, 26);
		panel_Pagination.add(comboChec);
		
		btnNext = new JButton("Next");
		btnNext.setBounds(253, 11, 60, 29);
		...
		list = new Liste_Attente(btnLast, btnNext, btnPrev, btnFirst, comboChec, "normal");
		list.setVisible(true);
	...
	private void filtrageDeux() {
		btnFiltrer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				list = new Liste_Attente(btnLast, btnNext, btnPrev, btnFirst, comboChec, "filtrage", debut, fin);
				list.setVisible(true);
	...
	private void basculation() {
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BASCULE_Attente attente = new BASCULE_Attente(tableau, btnLast, btnNext, btnPrev, btnFirst, comboChec, "normal");
