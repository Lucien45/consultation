...
public class Detail_Historique extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Detail_Historique(int id) {
		this.id = id;
		setResizable(false);
		...
		JLabel lblDetail = new JLabel("DETAIL DU HISTORIQUE");
		...
		lblTitreSortie = new JLabel("Sortie: ");
		lblTitreSortie.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblTitreSortie.setBounds(360, 194, 73, 34);
		panelContent.add(lblTitreSortie);
		
		lblSortie = new JLabel("");
		lblSortie.setBounds(451, 194, 170, 34);
		panelContent.add(lblSortie);
		
		lblTitreAttente = new JLabel("Attente: ");
		lblTitreAttente.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblTitreAttente.setBounds(362, 239, 73, 34);
		panelContent.add(lblTitreAttente);
		
		lblAttente = new JLabel("");
		lblAttente.setBounds(453, 239, 170, 34);
	...
	private void Detail() {
		...
		cons.detail_historique(lblID, lblNom, lblPrenom, lblAge, lblSexe, lblContact, lblAdresse, lblDate, lblMotif, lblDirection, lblSortie, lblAttente);
	}
}
