...
public class Detail_Sortie extends JFrame {
	...
	public Detail_Sortie(int id) {
		...
		JLabel lblDetail = new JLabel("DETAIL DE SORTIE");
	...
	private void Detail() {
		...
		s.detail_sortie(lblID, lblNom, lblPrenom, lblAge, lblSexe, lblContact, lblAdresse, lblDate, lblMotif, lblDirection, lblSortie);
